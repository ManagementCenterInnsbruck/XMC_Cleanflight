...
typedef XMC_GPIO_MODE_t GPIO_Mode;
...
static inline void digitalHi(GPIO_TypeDef *p, uint16_t i) { XMC_GPIO_SetOutputHigh(p, i); }
static inline void digitalLo(GPIO_TypeDef *p, uint16_t i) { XMC_GPIO_SetOutputLow(p, i); }
static inline void digitalToggle(GPIO_TypeDef *p, uint16_t i) { XMC_GPIO_ToggleOutput(p, i); }
static inline uint16_t digitalIn(GPIO_TypeDef *p, uint16_t i) { return XMC_GPIO_GetInput(p, i); }
#else
